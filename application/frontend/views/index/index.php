...
if (!empty($this->listSpecialCategories)) {
	foreach ($this->listSpecialCategories as $value1) {
		$categoryId = $value1['id'];
		$name 		= $value1['name'];

		$xhtmlSpecialCategories .= '
		<li' . $classCurrent . '>
			<a href="tab-category-' . $categoryId . '" class="my-product-tab" data-category="1">' . $name . '</a>
		</li>
		';
